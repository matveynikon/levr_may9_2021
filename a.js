  ...
  for (var c = 0; c < 50; c++){
    ...
    for (var z = 0; z < 13; z++){
      ...
      ///html/body/div[4]/div/div/div[2]/ul/div/li[2]/div/div[2]/div[1]/div/div/span
        //const elements = await page.$x('/html/body/div[4]/div/div/div[2]/ul/div/li/div/div[1]/div[2]/div[1]/span')
      //await page.evaluate(() => document.querySelector(nine).scrollIntoView());
      //await page.hover(nine);
        z += 8
        //await elements[z].click()
        await page.waitFor(2000)
      }
      else{
        console.log('still did not scroll')
      }
      if(z > 12){
        await page.mouse.click(400, 400)
        await page.waitFor(2000)
      ...
      ///html/body/div[4]/div/div/div[2]/ul/div/li[7]/div/div[1]/div[2]/div[1]/span
      ///html/body/div[4]/div/div/div[2]/ul/div/li[2]/div/div[2]/div[1]/div/div/span
        //const elements3 = await page.$x('/html/body/div[4]/div/div/div[2]/ul/div/li/div/div[1]/div[2]/div[1]/span')
      //await page.evaluate(() => document.querySelector(nine).scrollIntoView());
      //await page.hover(nine);
        z += 7
        //await elements3[z].click()
        await page.waitFor(2000)
      }
      else{
        console.log('still did not scroll')
      ...
      //await nine.click()
      try{
        const elements2 = await page.$x('/html/body/div[4]/div/div/div[2]/ul/div/li/div/div[2]/div[1]/div/div/span')
        await elements2[z].click()        
      }   
      catch{
