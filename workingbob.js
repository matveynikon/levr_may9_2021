...
arr2 = []
var daylist = getDaysArray(new Date('2021-04-01'),new Date('2021-05-01'));
...
async function start() {
  ...
  console.log(someVar);
  const url = 'https://twitter.com/search?q=(from%3' + someVar + ')%20until%3A' + '2021-05-01' + '%20since%3A' + '2021-04-01' + '%20-filter%3Areplies&src=typed_query&f=live';
