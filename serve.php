...
fwrite($myfile, $bro);
fwrite($myfile, $el2);
/*$txt = "async function start () {\n";
fwrite($myfile, $txt);
$txt = "  const browser = await puppeteer.launch({\n";
fwrite($myfile, $txt);
$txt = "    args: ['--no-sandbox']\n";
fwrite($myfile, $txt);
$txt = "  })\n";
...
$txt = "  for (x = 5; x > 0; x--) {\n";
fwrite($myfile, $txt);
$txt = "    const page = await browser.newPage()\n";
fwrite($myfile, $txt);
$txt = "    await page.goto(";
fwrite($myfile, $txt);
$txt = $_POST["name"];
...
$txt = ")\n";
fwrite($myfile, $txt);
$txt = "    await page.waitFor(5000)\n";
fwrite($myfile, $txt);
$txt = "    await page.close()\n";
fwrite($myfile, $txt);
$txt = "  }\n";
fwrite($myfile, $txt);
$txt = "  await browser.close()\n";
fwrite($myfile, $txt);
$txt = "}\n";
fwrite($myfile, $txt);
$txt = "start()\n";
